...
//        let permissions: Set<HKSampleType> = [caloriesConsumed, numberOfAlcoholicDrinks]
        ...
        healthStore.requestAuthorization(toShare: [caloriesConsumed, numberOfAlcoholicDrinks], read: []) { success, error in
            completion(success)
        }
